...
class CabangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Cabang berhasil ditambahkan'], 201);
        } catch (\Exception $e) {
            return response()->json(['success' => false, 'message' => 'Terjadi kesalahan saat menambahkan cabang: ' . $e->getMessage()], 500);
        }
    }
