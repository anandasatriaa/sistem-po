...
class CreatePurchaseOrderMileniaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_milenia', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchase_order_milenia');
    }
}
