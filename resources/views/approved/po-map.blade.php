...
<body>
    <div class="container mt-4 bg-white rounded-3 shadow-lg p-4">
        ...
        <div class="text-center mb-5">
            <h1 class="display-5 fw-bold text-primary">Approved Purchase Order MAP</h1>
            <img src="{{ asset('assets/images/map-logo.png') }}" alt="" width="100px">
        ...
        <div class="card border-primary mb-4">
            ...
            <div class="card-body p-0">
                <iframe src="{{ url('/pdf-view-map/' . $po->id) }}" class="w-100"
