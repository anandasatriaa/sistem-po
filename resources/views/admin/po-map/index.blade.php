                ...
                <div class="row justify-content-between mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4 mt-2">
                            <input type="text" name="namapembuat_po" class="form-control" id="namapembuat_po" value="Windy Wulandari" placeholder="Nama Pembuat PO" required>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        document.getElementById('no_po').addEventListener('change', function() {
            ...
            fetch(`{{ route('admin.po-map-data') }}?no_po=${encodeURIComponent(noPo)}`)
                .then(response => response.json())
                .then(data => {
