        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-9"> <!-- Full width di mobile, 9 columns di desktop -->
                    <h5 class="card-title mb-0">Input Purchase Order Milenia</h5>
                </div>
                <!-- Logo -->
                <div class="col-12 col-md-3 text-center text-md-end mt-3 mt-md-0">
                    <!-- Full width di mobile, 3 columns di desktop -->
                    <img src="{{ asset('assets/images/logo-milenia-2.png') }}" class="img-fluid" style="max-width: 60px"
                        alt="Logo Milenia">
                </div>
            </div>
        </div>
            ...
            <form id="po-form" action="" class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-milenia" id="newPoBtn">New PO</button>
                    </div>
                    <datalist id="poList">
                        @foreach ($nopomilenia as $n)
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="date" name="date_po" class="form-control" data-provider="flatpickr" id="date_po"
                            required>
                        <span class="input-group-text bg-milenia text-white">
                            <i class="ri-calendar-todo-line"></i>
                        </span>
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="estimatedate_po" class="form-label"><span class="text-danger">*</span>Estimate
                        Date</label>
                    <div class="input-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-milenia" id="add-row" type="button"><i class="ri-add-line"></i> Tambah
                            Baris</button>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-milenia" id="create-btn">
...
@section('script')
    ...
    <script>
        document.getElementById('preview-btn').addEventListener('click', function() {
            ...
            fetch('{{ url('/admin/input-po-milenia/preview') }}', {
                    method: 'POST',
                    headers: {
    ...
    <script>
        ...
        document.getElementById('po-form').addEventListener('submit', function(event) {
            ...
            console.log("URL yang digunakan:", '{{ route('admin.po-milenia-store') }}');

            // --- Kirim data menggunakan fetch AJAX ---
            fetch('{{ route('admin.po-milenia-store') }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
