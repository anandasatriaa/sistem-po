...
<body>
    ...
    <table cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse; font-size: 13px;">
        ...
        <tr style="border-bottom: 1px solid #000;">
            ...
            <td colspan="3" style="width: 40%; padding: 3;">{{ $formData['address'] }}</td>
            <td style="width: 10%; padding: 3;"><strong>Address: </strong></td>
            <td style="width: 40%; padding: 3;">{{ $formData['cabang_alamat'] }}</td>
        </tr>
        <tr style="border-bottom: 1px solid #000;">
            <td style="width: 10%; padding: 3;"><strong>Phone: </strong></td>
            <td style="width: 17%; padding: 3;">{{ $formData['phone'] }}</td>
            <td style="width: 10%; padding: 3; text-align: right;"><strong>Fax: </strong></td>
            <td style="width: 15%; padding: 3;">{{ $formData['fax'] }}</td>
            <td style="width: 10%; padding: 3;"><strong>Phone: </strong></td>
            <td style="width: 35%; padding: 3;">{{ $formData['cabang_telepon'] }}</td>
        </tr>
        <tr style="border-bottom: 1px solid #000;">
            <td style="width: 10%; padding: 3;"><strong>UP: </strong></td>
            <td colspan="3" style="width: 40%; padding: 3;">{{ $formData['up'] }}</td>
            <td style="width: 10%; padding: 3;"><strong>NO: </strong></td>
            <td style="width: 40%; padding: 3;">{{ $formData['no_po'] }}</td>
        </tr>
        <tr style="border-bottom: 1px solid #000;">
            <td style="width: 10%; padding: 3;"><strong>Cabang: </strong></td>
            <td colspan="3" style="width: 40%; padding: 3;">{{ $formData['cabang'] }}</td>
            <td style="width: 10%; padding: 3;"><strong>Kategori: </strong></td>
            <td style="width: 40%; padding: 3;">{{ $formData['category'] }}</td>
        </tr>
        <tr style="border-bottom: 1px solid #000;">
